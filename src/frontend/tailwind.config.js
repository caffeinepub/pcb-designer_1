    ...
    theme: {
        ...
        extend: {
            ...
            colors: {
                ...
                pcb: {
                    green: 'oklch(0.22 0.08 155)',
                    'green-light': 'oklch(0.28 0.09 155)',
                    'green-dark': 'oklch(0.16 0.06 155)',
                    grid: 'oklch(0.30 0.07 155)',
                },
                charcoal: {
                    DEFAULT: 'oklch(0.16 0.01 160)',
                    light: 'oklch(0.20 0.01 160)',
            ...
            boxShadow: {
                ...
                'amber-glow': '0 0 8px oklch(0.72 0.16 85 / 0.4)',
                'pcb-inset': 'inset 0 1px 3px rgba(0,0,0,0.4)',
            },
            keyframes: {
                'accordion-down': {
                    from: { height: '0' },
