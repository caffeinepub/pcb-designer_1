...
export class Backend implements backendInterface {
    ...
    async getBoardstoreKeys(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBoardstoreKeys();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listDesigns(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async loadDesign(arg0: string): Promise<PCBDesign> {
        if (this.processError) {
            try {
                const result = await this.actor.loadDesign(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveDesign(arg0: PCBDesign): Promise<void> {
        if (this.processError) {
            try {
